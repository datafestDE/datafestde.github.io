...
<iframe width="560" height="315" src="https://www.youtube.com/embed/JjdhtWYYPFQ" frameborder="0" allowfullscreen></iframe>
...
Mehr Impressionen vom Datafest 2016 gibt es [hier](gallery.html)
...
![Gebäudeplan Erdgeschoss](files/E004_v01-1.png)

![Gebäudeplan 1. Stock](files/Senatssaal_v01_small.png)  
...
Für die beiden großen Arbeitsräume haben wir folgende Verteilung vorgesehen, und je zwei bis drei Teams teilen sich einen Aufenthaltsraum in dem in Ruhe gearbeitet und ausgeruht werden kann:

Arbeitsraum |Aufenthaltsraum | Teams
------------|----------------|-----------
F 107       |C 005           | DatenKnechte, Mannheimer Psychologen
F 107       |C 009           | DataAnimals, R-Furcht
F 107       |C 016           | R-squared Mannheim, DataRtists
F 107       |C 022           | Heavy Tails, The final Estimation
F 107       |B 011           | SozioLogits, DeepForest, supeRuser
A 120       |A 020           | FAUdatalyze, R-Force
A 120       |DZ 001          | AngSt, Angst 2.0
A 120       |DZ 003          | Statisfaction, RatedR, TheScatterplotter
A 120       |DZ 005          | Joint Modelling, Diverse Impact
A 120       |DZ 007          | Otto-Normalverteilung, expeRience

![Wegweiser DZ-Räume](files/dz_raeume-1.png) 

Alle Räume sind im Hauptgebäude der LMU am Geschwister-Scholl-Platz.  
Für die sichere Aufbewahrung eurer Wertsachen könnt ihr die Schließfächer direkt unter Raum F107 nutzen (akzeptieren 1- oder 2-Euro-Münzen), die Haftung können wir aber nicht übernehmen.
...
Gebäudeplan Erdgeschoss [[pdf]](files/E004_v01.pdf)  
Gebäudeplan 1. OG [[pdf]](files/Senatssaal_v01.pdf)  
Gebäudeplan DZ-Räume [[pdf]](files/dz_raeume.pdf)
...
## Helfer
<center>
![Bernd - LMU (Organisator)](files/bischl.jpg)

![Frauke - Uni Mannheim (Organisatorin)](files/kreuter.png)

![Giuseppe - LMU](files/giuseppe.jpg) 

![Janek - LMU](files/janek.jpg)

![Andreas - LMU](files/andreas.jpg) 

![Fabian S. - LMU](files/fabian.png)

![Sarah - LMU](files/sarah.jpg)

![Andreas - LMU](files/andreasb.bmp)

![David - LMU](files/davidr.jpg)

![Gunther - LMU](files/gunter.jpg)

![Malte - Uni Mannheim](files/malte.jpeg)

![Felix - Uni Mannheim](files/felix.jpg)

![Arne - Uni Mannheim](files/arne.png)

![Barbara - Uni Mannheim](files/Barbara.png)

![Christoph B. - P3](files/Christoph.jpg)

![Nils - P3](files/Nils_Drescher.PNG)

![Markus - P3](files/Markus.jpg)

![Sabine - P3](files/SabineFeyen.PNG)

![Fabian H. - P3](files/FabianHillig.jpg)

![Christof - P3](files/ChristofHorn.PNG)

![Zeeshan - P3](files/Khan_Zeeshan.jpg)

![Ralf - P3](files/Ralf.jpg)

![Tobias - P3](files/TobiasLoehr.PNG)

![Raquel - P3](files/Sabarich_Raquel.jpg)

![Mladen - P3](files/Savic_Mladen.png)

![Salman - P3](files/SalmanSwaid.PNG)

![Michael - P3](files/Wennesheimer_Michael.jpg)

![Peter - P3](files/Werth_Peter.jpg)

![Dominik - Cliqz](files/dominik.jpg)

![Konark - Cliqz](files/konark.jpg)

![Harry - Cliqz](files/harry.jpg)
